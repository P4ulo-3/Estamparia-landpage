          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              {["Instagram", "Facebook", "WhatsApp"].map((social) => {
                const links = {
                  Instagram:
                    "https://www.instagram.com/renoveestamparia?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
                  Facebook: "#",
                  WhatsApp:
                    "https://wa.me/5585981250926?text=Olá! Gostaria de fazer um orçamento.",
                };
            ...
            {/* <div className="flex items-center gap-3">
              {["Instagram", "Facebook", "WhatsApp"].map((social) => (
                ...
                >
                  {social === "Instagram" && (
                    <a
                      href="https://www.instagram.com/renoveestamparia?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                      target="blank"
                      rel="noopener noreferrer"
                    >
                      <svg
        ...
        <div className="border-t border-primary-foreground/10 pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="font-sans text-xs text-primary-foreground/40">
              &copy; {new Date().getFullYear()} Renove Estamparia. Todos os
              direitos reservados.
            </p>
            <p className="font-sans text-xs text-primary-foreground/40">
